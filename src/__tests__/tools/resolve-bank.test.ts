...
import { executeFindBank } from '../../tools/resolve-bank.ts';
...
describe('executeFindBank', () => {
    it('returns first match from API', async () => {
        ...
        const result = await executeFindBank(mockEnv, 'vcb');
    ...
    it('returns null when no match', async () => {
        ...
        const result = await executeFindBank(mockEnv, 'xyz-unknown');
